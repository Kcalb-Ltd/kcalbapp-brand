...
<p>
<img src="assets/png/square/kcalbapp-square-200.png" width="96" alt="KcalbApp app icon">&nbsp;
<img src="assets/png/round/kcalbapp-round-200.png" width="96" alt="KcalbApp round avatar">&nbsp;
<img src="assets/png/symbol-color/kcalbapp-symbol-color-200.png" width="96" alt="KcalbApp symbol">
</p>
...
Direct links, for integrations: `https://raw.githubusercontent.com/KcalbApp/kcalbapp-brand/main/assets/png/round/kcalbapp-round-500.png`. For production, pin a commit hash instead of `main` and check the file against [asset-manifest.json](asset-manifest.json).
...
[`assets/email-signature/`](assets/email-signature/) holds the eight slices of the Kcalb Ltd email signature banner, at twice the display size for high-density screens. Each brand icon is a separate image so that it can link to its own website.
...
Questions and requests: **contact@kcalb-ltd.com**, or open an [issue](https://github.com/KcalbApp/kcalbapp-brand/issues).
